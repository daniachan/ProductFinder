...
import com.dania.productfinder.repository.PlpRepository
import com.dania.productfinder.util.AbsentLiveData
import com.dania.productfinder.vo.*

//@OpenForTesting
class SearchViewModel @Inject constructor(plpRepository: PlpRepository) : ViewModel() {
    private val _query = MutableLiveData<String>()
    private val nextPageHandler = NextPageHandler(plpRepository)
    val deleteItems = DeleteItems(plpRepository)

    val query : LiveData<String> = _query
    val listSuggest: LiveData<List<SearchResult>> = plpRepository.getAllSugges()
